...
function MyLinks() {
  return (
    <div className="flex flex-row gap-x-10 p-4 rounded-full bg-transparent">
      <a
        target="_blank"
        href="https://github.com/mustafasnr"
        className={
          "w-10 h-10 bg-transparent overflow-hidden shadow-2xl shadow-black hover:scale-110 rounded-sm transition-transform duration-150"
        }
      >
        <svg
      ...
      <a
        target="_blank"
        href="https://www.linkedin.com/in/mustafasoner/"
        className={
          "w-10 h-10 bg-transparent overflow-hidden shadow-2xl shadow-black hover:scale-110 rounded-sm transition-transform duration-150"
        }
      >
      ...
      <a
        target="_blank"
        href="https://www.kaggle.com/mustafasoner"
        className={
          "w-10 h-10 bg-transparent overflow-hidden shadow-2xl shadow-black hover:scale-110 rounded-sm transition-transform duration-150"
        }
      >
